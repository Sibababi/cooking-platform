...
import { categurieRoutes } from './routes/categurie.routes';
...
class Server {
  ...
  public routes(): void {
    this.app.use('/api/v1/reviews', reviewRoutes.router);

    this.app.use('/api/v1/ingredients', ingredientsRoutes.router);

    this.app.use('/api/v1/recipes', recipesRoutes.router);

    this.app.use('/api/v1/categuries', categurieRoutes.router);
